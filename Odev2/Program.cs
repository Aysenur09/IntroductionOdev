...
namespace Odev2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            switch (ay)
            {
                case "ocak": Console.WriteLine("KIŞ");
                    Console.WriteLine("1.AY");
                    break;     
                    
                case "şubat": Console.WriteLine("KIŞ");
                    Console.WriteLine("2.AY");
                    break;

                case "mart": Console.WriteLine("İLKBAHAR");
                    Console.WriteLine("3.AY");
                    break;

                case "nisan": Console.WriteLine("İLKBAHAR");
                    Console.WriteLine("4.AY");
                    break;

                case "mayıs": Console.WriteLine("İLKBAHAR");
                    Console.WriteLine("5.AY");
                    break;

                case "haziran": Console.WriteLine("YAZ");
                    Console.WriteLine("6.AY");
                    break;

                case "temmuz": Console.WriteLine("YAZ");
                    Console.WriteLine("7.AY");
                    break;

                case "ağustos": Console.WriteLine("YAZ");
                    Console.WriteLine("8.AY");
                    break;

                case "eylül": Console.WriteLine("SONBAHAR");
                    Console.WriteLine("9.AY");
                    break;

                case "ekim": Console.WriteLine("SONBAHAR");
                    Console.WriteLine("10.AY");
                    break;

                case "kasım": Console.WriteLine("SONBAHAR");
                    Console.WriteLine("11.AY");
                    break;

                case "aralık": Console.WriteLine("KIŞ");
